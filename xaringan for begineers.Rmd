...
The `class: center, middle` arguments also work with regular slides.
...
The above use of the `class` argument will change the appearance of the full slide. If you want to align only parts of your slides, you need to wrap it inside square brackets after specifying what format class you want.  
Example to center align something, you can add the text to center between `.center[text]`. 
